/* linux/arch/arm/mach-apple_iphone/include/mach/regs-usb-otg-hs.h
 *
...
#define S3C24XX_VA_OTGSFR		IO_ADDRESS(0x3C400000)
#define S3C24XX_VA_OTG			IO_ADDRESS(0x38400000)
...
#define DEPCTL_INTR_TYPE                        (0x4<<18)
